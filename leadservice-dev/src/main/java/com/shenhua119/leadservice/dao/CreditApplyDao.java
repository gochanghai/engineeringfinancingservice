...
public interface CreditApplyDao extends BaseMapper<ProjectCreditApply> {
    ...
    /** 返回工程公司授信申请数据 */
    @Select("SELECT tb1.id, tb1.apply_no, tb1.apply_date,tb1.step,tb1.apply_amount,tb1.`status`,tb2.project_name," +
    ...
    /** 返回平台授信申请数据 */
    @Select("SELECT tb1.id,tb1.name, tb1.apply_no,tb1.apply_amount,tb1.apply_date,tb1.step,tb3.project_name,tb1.`status`," +
