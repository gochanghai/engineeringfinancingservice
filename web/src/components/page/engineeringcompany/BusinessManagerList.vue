    ...
    <div class="table">
        ...
        <div class="container" >
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="name" label="姓名" sortable width="200" align="center">
                </el-table-column>
                <el-table-column label="性别" width="120" align="center">
                    <template slot-scope="scope">
                        <el-tag type="warning" v-show="scope.row.gender === 'M'">男</el-tag>
                        <el-tag type="warning" v-show="scope.row.gender === 'F'">女</el-tag>
                    </template>
                </el-table-column>
                <el-table-column prop="phone" label="手机号码" width="200" align="center">
                </el-table-column>
                <el-table-column prop="jobYearNumber" label="从业年限" width="100" align="center">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="childCompanyName" label="所属分公司" align="center">
                </el-table-column>
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        <el-button type="warning" size="min" @click="handleEdit(scope.$index, scope.row)">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    export default {
        ...
        methods: {
            getDataList(id){
                let _than = this;
                this.$axios.get('http://192.168.1.98:8088/financier/list',{params:{
                        id: id
            ...
            add(){
                // 设置路由页面跳转
                this.$router.push('business-manager-add');
            }
        }
    }
