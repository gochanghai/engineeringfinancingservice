    ...
    <div class="table">
        ...
        <div class="container" >
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="date" label="申请日期" align="center">
                </el-table-column>
                ...
                <el-table-column prop="companyFullName" label="资金渠道">
                </el-table-column>
                ...
                <el-table-column label="操作" width="160" align="left">
                    <template slot-scope="scope">
                        <el-button type="primary" plain size="mini" @click="addProjectInfo(scope.row.id)">详情</el-button>
                        <el-button type="warning" size="mini" v-if="scope.row.step === 2 " v-show="scope.row.status === 0" @click="goApply(scope.row.id)">去审批</el-button>
                        <el-button type="warning" size="mini" v-if="scope.row.step === 1 " v-show="scope.row.status === 0" @click="handleEdit(scope.$index, scope.row)">去完善</el-button>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 完善资料
            addProjectInfo(creditId){
                this.$router.push({
                    path:'add-project-info?id=' + creditId
                })
            },
            // 去审批
            goApply(id){
