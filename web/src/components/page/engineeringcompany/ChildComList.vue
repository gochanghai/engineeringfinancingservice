<template>
    <div class="">
        ...
        <!--</div>-->
        <div class="container" >
            <div style="width: 100%; border-left: 3px solid #ff8208; padding: 5px 20px; margin-bottom: 50px">分公司管理</div>
            <div class="handle-box">
                ...
                <el-button type="primary" icon="el-icon-plus" @click="add">添加分公司</el-button>
            </div>
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column type="index" label="序号" width="50" align="center"></el-table-column>
                <el-table-column prop="companyName" label="分公司名称" align="center">
                </el-table-column>
                <el-table-column prop="companyAddress" label="分公司地址" align="center">
                </el-table-column>
...
<script>
    export default {
        ...
        created() {
            ...
            this.$axios.get('http://192.168.1.98:8088/cc/list',{params:{
                id: this.companyId
