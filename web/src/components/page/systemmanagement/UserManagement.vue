<template>
    <div class="">
        ...
        <!--</div>-->
        <div class="container" >
            <div style="width: 100%; border-left: 3px solid #ff8208; padding: 5px 20px; margin-bottom: 50px">用户管理</div>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="类别" align="center" width="200px">
            ...
            <!--</div>-->
            <div>
                <!--<img src="http://192.168.1.89/group1/M00/00/00/wKgBWVwY1SKAaoVfAAN9O0dIAx8286.pdf"/>-->
                <!--<template>-->
                    <!--<iframe src="http://192.168.1.89/group1/M00/00/00/wKgBWVwY1SKAaoVfAAN9O0dIAx8286.pdf" width="100%" height="500px"></iframe>-->
                <!--</template>-->
            </div>
        </div>
...
<script>
    export default {
        ...
        created() {
            ...
            this.$axios.get('http://192.168.1.98:8088/user/users',{params:{
                id: 0
