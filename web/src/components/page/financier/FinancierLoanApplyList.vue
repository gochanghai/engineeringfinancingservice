        ...
        <div class="crumbs">
            <el-breadcrumb class="breadcrumb" separator="/">
                <el-breadcrumb-item class="breadcrumb-item">
                    ...
                    我的放款申请列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" >
            <div class="handle-box">
                <el-button type="warning" icon="search" @click="add">申请放款</el-button>
                <!--<el-button type="primary" icon="search" @click="add" style="margin-left: 300px">新增</el-button>-->
            </div>
            <el-table :data="tableData" border class="table" ref="multipleTable">
                <el-table-column type="index" label="序号" width="100" align="center">
                </el-table-column>
                <el-table-column prop="loanNo" label="申请编号" sortable width="200" align="center">
                </el-table-column>
                ...
                <el-table-column label="本次申请放款额" width="200" align="center">
                    <template slot-scope="scope">
                        {{ scope.row.loanAmount }}.00万
                    </template>
                </el-table-column>
                <el-table-column label="状态" width="200" align="center">
                    <template slot-scope="scope">
                        <el-tag v-show="scope.row.status === '0'">审批中</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button type="warning" plain @click="handleEdit(scope.$index, scope.row)">详情</el-button>
                        <el-button type="warning" plain @click="handleEdit(scope.$index, scope.row)">支付服务费</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    export default {
        ...
        methods: {
            ...
            add(){
                // 设置路由页面跳转
                this.$router.push('add-loan-apply');
            }
        }
    }
