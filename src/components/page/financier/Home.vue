<template>
    <div>
        <el-row :gutter="20">
            <el-col>
                <el-card shadow="hover" class="product-box">
                    ...
                    <div class="product-list">
                        <div class="product-list-item">
                            ...
                            <div class="product-btn-box">
                                <div class="product-btn1" @click="creditApply">申请授信</div>
                                <div class="product-btn2" @click="loanApply">申请放款</div>
                            </div>
                        </div>

                        <div class="product-list-item">
                            <div class="product-card">
                                <img src="../../../../static/img//fyd.png"/>
                            </div>
                        ...
                        <div class="product-list-item" v-for="item in 2">
                            <div class="product-card">
                                <img src="../../../../static/img/qt.png"/>
                            </div>
